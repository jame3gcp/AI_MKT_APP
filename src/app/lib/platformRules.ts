...
export function checkLength(_platform: string, _text: string): { valid: boolean; warning?: string } {
...
export function checkPolicy(_text: string, _platform: string): { warnings: string[] } {
  // 플랫폼별 정책 위반 검증 (예시)
